...
//
// --- Specializations - Grouped by functions ---
//
...
template<> float LXPropertyT<float>::CheckRange(const float& value) { return ::CheckRange(this, value); }
template<> double LXPropertyT<double>::CheckRange(const double& value) { return ::CheckRange(this, value); }
template<> int LXPropertyT<int>::CheckRange(const int& value) { return ::CheckRange(this, value); }
template<> uint LXPropertyT<uint>::CheckRange(const uint& value) { return ::CheckRange(this, value); }
template <class T>
