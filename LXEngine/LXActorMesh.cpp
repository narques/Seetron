...
void LXActorMesh::DefineProperties( ) 
{
	...
	//Asset
	LXPropertyAsset* PropAssetMesh = LXPropertyAsset::Create(this, L"AssetMesh", (std::shared_ptr<LXAsset>*)&_AssetMesh);
	PropAssetMesh->ValueChanged.AttachMemberLambda([this](LXProperty*)
	{
